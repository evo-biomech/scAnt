...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.spinBox_maskingFocusThreshold = QtWidgets.QSpinBox(self.frame_post_processing)
        self.spinBox_maskingFocusThreshold.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.spinBox_maskingFocusThreshold.setFont(font)
        self.spinBox_maskingFocusThreshold.setMaximum(254)
        self.spinBox_maskingFocusThreshold.setProperty("value", 20)
        self.spinBox_maskingFocusThreshold.setObjectName("spinBox_maskingFocusThreshold")
        self.gridLayout_5.addWidget(self.spinBox_maskingFocusThreshold, 7, 2, 1, 1)
        ...
        self.label_maskMethod = QtWidgets.QLabel(self.frame_post_processing)
        self.label_maskMethod.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_maskMethod.setFont(font)
        self.label_maskMethod.setObjectName("label_maskMethod")
        self.gridLayout_5.addWidget(self.label_maskMethod, 5, 0, 1, 1)
        self.comboBox_maskMethod = QtWidgets.QComboBox(self.frame_post_processing)
        self.comboBox_maskMethod.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.comboBox_maskMethod.setFont(font)
        self.comboBox_maskMethod.setObjectName("comboBox_maskMethod")
        self.comboBox_maskMethod.addItems(["adaptive", "hsv_focus", "grabcut"])
        self.gridLayout_5.addWidget(self.comboBox_maskMethod, 5, 2, 1, 1)
        self.label_maskThreshold = QtWidgets.QLabel(self.frame_post_processing)
        self.label_maskThreshold.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_maskThreshold.setFont(font)
        self.label_maskThreshold.setObjectName("label_maskThreshold")
        self.gridLayout_5.addWidget(self.label_maskThreshold, 6, 0, 1, 1)
        self.doubleSpinBox_maskThreshold = QtWidgets.QDoubleSpinBox(self.frame_post_processing)
        self.doubleSpinBox_maskThreshold.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.doubleSpinBox_maskThreshold.setFont(font)
        self.doubleSpinBox_maskThreshold.setDecimals(2)
        self.doubleSpinBox_maskThreshold.setMinimum(0.10)
        self.doubleSpinBox_maskThreshold.setMaximum(1.00)
        self.doubleSpinBox_maskThreshold.setSingleStep(0.05)
        self.doubleSpinBox_maskThreshold.setProperty("value", 0.50)
        self.doubleSpinBox_maskThreshold.setObjectName("doubleSpinBox_maskThreshold")
        self.gridLayout_5.addWidget(self.doubleSpinBox_maskThreshold, 6, 2, 1, 1)
        self.spinBox_maskingSaturationThreshold = QtWidgets.QSpinBox(self.frame_post_processing)
        self.spinBox_maskingSaturationThreshold.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.spinBox_maskingSaturationThreshold.setFont(font)
        self.spinBox_maskingSaturationThreshold.setMaximum(254)
        self.spinBox_maskingSaturationThreshold.setProperty("value", 70)
        self.spinBox_maskingSaturationThreshold.setObjectName("spinBox_maskingSaturationThreshold")
        self.gridLayout_5.addWidget(self.spinBox_maskingSaturationThreshold, 8, 2, 1, 1)
        ...
        self.label_maskingSaturationThreshold = QtWidgets.QLabel(self.frame_post_processing)
        self.label_maskingSaturationThreshold.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_maskingSaturationThreshold.setFont(font)
        self.label_maskingSaturationThreshold.setObjectName("label_maskingSaturationThreshold")
        self.gridLayout_5.addWidget(self.label_maskingSaturationThreshold, 8, 0, 1, 1)
        self.label_maskingFocusThreshold = QtWidgets.QLabel(self.frame_post_processing)
        self.label_maskingFocusThreshold.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        self.label_maskingFocusThreshold.setFont(font)
        self.label_maskingFocusThreshold.setObjectName("label_maskingFocusThreshold")
        self.gridLayout_5.addWidget(self.label_maskingFocusThreshold, 7, 0, 1, 1)
        ...
        self.pushButton_runPostProcessing = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.gridLayout_6.addWidget(self.pushButton_runPostProcessing, 2, 2, 1, 1)
        ...
        self.doubleSpinBox_zMax.setMaximum(7000.0)
        ...
        self.doubleSpinBox_zStep.setMaximum(7000.0)
        ...
        self.horizontalSlider_zAxis.setMaximum(7000)
        ...
        self.label_rotationOffset = QtWidgets.QLabel(self.frame_stepperControl)
        self.label_rotationOffset.setEnabled(False)
        self.label_rotationOffset.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_rotationOffset.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_rotationOffset.setObjectName("label_rotationOffset")
        self.gridLayout.addWidget(self.label_rotationOffset, 7, 4, 1, 1)
        self.spinBox_rotationOffset = QtWidgets.QSpinBox(self.frame_stepperControl)
        self.spinBox_rotationOffset.setEnabled(False)
        self.spinBox_rotationOffset.setObjectName("spinBox_rotationOffset")
        self.gridLayout.addWidget(self.spinBox_rotationOffset, 7, 5, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_maskMethod.setText(_translate("MainWindow", "Mask method"))
        self.label_maskThreshold.setText(_translate("MainWindow", "Threshold multiplier"))
        self.label_maskingSaturationThreshold.setText(_translate("MainWindow", "Mask saturation thresh"))
        self.label_maskingFocusThreshold.setText(_translate("MainWindow", "Mask focus thresh"))
        ...
        self.pushButton_runPostProcessing.setText(_translate("MainWindow", "Run Post Processing Only"))
        ...
        self.label_rotationOffset.setText(_translate("MainWindow", "Rotation Offset"))
